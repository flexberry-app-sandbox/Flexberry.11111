namespace 11111.ApplicationLayer.Services
{
    using System;
    using System.Linq;
    using System.Net;
    ...
    /// </summary>
    public class 11111CurrentUserService : I11111CurrentUserService
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="11111CurrentUserService"/> class.
        /// </summary>
        /// <param name="httpContextAccessor">Доступ к текущему контексту.</param>
        /// <param name="dataService">Сервис для вычитки данных.</param>
        public 11111CurrentUserService(IHttpContextAccessor httpContextAccessor, IDataService dataService)
        {
