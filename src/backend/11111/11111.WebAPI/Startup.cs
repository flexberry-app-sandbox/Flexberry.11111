    ...
    public class Startup
    {
        ...
        public static void Configure(IApplicationBuilder app, IWebHostEnvironment env, IConfiguration config)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                {
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "11111 API v1");
        ...
        public void ConfigureContainer(IUnityContainer container)
        {
            ...
            container.RegisterType<INewClass1Service, NewClass1Service>();
            ...
            11111CurrentUserService currentUserService = new (container.Resolve<IHttpContextAccessor>(), container.Resolve<IDataService>());

            container.RegisterInstance<I11111CurrentUserService>(currentUserService);
